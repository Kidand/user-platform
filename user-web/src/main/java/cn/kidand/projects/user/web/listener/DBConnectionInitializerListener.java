package cn.kidand.projects.user.web.listener;

import cn.kidand.projects.user.sql.DBConnectionManager;
import cn.kidand.projects.user.sql.DBConnectionManagerFactory;
...
import static cn.kidand.projects.user.sql.DBConnectionManager.CREATE_USERS_TABLE_DDL_SQL;
import static cn.kidand.projects.user.sql.DBConnectionManager.DROP_USERS_TABLE_DDL_SQL;
/**
*
*  ██╗  ██╗██╗██████╗  █████╗ ███╗   ██╗██████╗
*  ██║ ██╔╝██║██╔══██╗██╔══██╗████╗  ██║██╔══██╗
...
*  ╚═╝  ╚═╝╚═╝╚═════╝ ╚═╝  ╚═╝╚═╝  ╚═══╝╚═════╝
*
* @description:DBConnectionInitializerListener
* @author: Kidand
* @date: 2021/3/10 7:36 下午
